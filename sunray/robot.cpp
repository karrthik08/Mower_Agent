...
//  #endif
  ...
  // Auto-start mowing automatically in simulator
         CONSOLE.println(F("AUTOSTART: starting mowing automatically (simulator mode)"));
...
void setOperation(OperationType op, bool allowRepeat){  
  ...
  //   // Auto-start mowing automatically in simulator
  //   CONSOLE.println("AUTOSTART: starting mowing automatically (simulator mode)");
  //   setOperation(OP_MOW, true);
  //   startMow();
  // #endif
    //Logger.event(EVT_SYSTEM_STARTED);
